...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['action']) && $_POST['action'] == "#001" && isset($_POST['name']) && isset($_POST['email']) && isset($_POST['pwd'])){
    reg_user();     //call the reg_user function which has been imported from the functions.php file
}


if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['action']) && $_POST['action'] == "#002" && isset($_POST['email']) && isset($_POST['pwd'])){
