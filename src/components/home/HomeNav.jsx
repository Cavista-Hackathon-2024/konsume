...
const HomeNav = () => {
    ...
    return (
        <div className='flex items-center justify-between bg-[#C0DFB44D] border-[2.5px] rounded-[20px] border-[#DDF1D4] py-[11px] md:px-[63px] px-[30px] mt-8 md:mt-0'>
            <img src={logo} alt="logo" className=' mr-20 w-[39px] md:w-[94px]' />
