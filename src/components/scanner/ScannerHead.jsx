    ...
    <div className='font-jakarta bg-[#BEFFA74F] p-5 mt-7 rounded-2xl'>
      <div className='flex justify-between'>
        ...
        <div className='flex flex-col gap-5 md:w-[488px]'>
          ...
          <p className=' text-sm font-light'>Explore personalized nutrition with Konsume's Food Scanner. Upload a food picture, and our AI analyzes it for nutritional info, allergens, and health goal alignment. Empower your food choices— <span className='text-[#FFC501]'>try it now!</span></p>
        </div>
